...
class SearchImages < RequestBase
  ...
  QUERY_PARAMS_NAMES = ["date_from", "date_to","phrase","editorial_segments","graphical_styles","license_models","orientations","exclude_nudity","fields","embed_content_only","page","page_size","sort_order"]
